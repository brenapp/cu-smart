...
def predict_probability(clothing_level, indoor_temp, indoor_humidity, outdoor_temp, outdoor_humidity, Time, ID):
    ...
    data = [[clothing_level, indoor_temp, indoor_humidity, outdoor_temp, outdoor_humidity, Time]]
    X = pd.DataFrame(data)
...
if __name__ == "__main__":
    ...
    result = predict_probability(clothing_level, indoor_temp, indoor_humidity, outdoor_temp, outdoor_humidity, Time, ID)
    print(result)